...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('txcommon_userenaprofile', 'company_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.phone_number'
        db.add_column('txcommon_userenaprofile', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.company_name'
        db.delete_column('txcommon_userenaprofile', 'company_name')

        # Deleting field 'Profile.phone_number'
        db.delete_column('txcommon_userenaprofile', 'phone_number')
