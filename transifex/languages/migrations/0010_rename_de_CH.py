...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Change name of language with code 'de_CH' from
        'Swiss German' to 'German (Switzerland)'
        """
        try:
            de_CH = orm['languages.Language'].objects.get(code='de_CH',
                    name='Swiss German')
    ...
    def backwards(self, orm):
        """Change name of language with code 'de_CH' from
        'German (Switzerland)' to 'Swiss German'
        """
        try:
            de_CH = orm['languages.Language'].objects.get(code='de_CH',
                    name='German (Switzerland)')
            de_CH.name = 'Swiss German'
            de_CH.save()
        except orm['languages.Language'].DoesNotExist:
            pass
