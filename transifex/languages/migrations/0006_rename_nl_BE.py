...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Change name of language with code 'nl_BE' from
        'Dutch (Belgium/Flemish)' to 'Dutch (Belgium)'
        """
        try:
            nl_BE = orm['languages.Language'].objects.get(code='nl_BE',
    ...
    def backwards(self, orm):
        """Change name of language with code 'nl_BE' from
        'Dutch (Belgium)' to 'Dutch (Belgium/Flemish)'
        """
        try:
            nl_BE = orm['languages.Language'].objects.get(code='nl_BE',
                    name='Dutch (Belgium)')
            nl_BE.name = 'Dutch (Belgium/Flemish)'
            nl_BE.save()
        except orm['languages.Language'].DoesNotExist:
            pass
