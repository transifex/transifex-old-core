...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Change name of language with code 'es_AR' from
        'Spanish (Argentinian)' to 'Spanish (Argentina)'
        """
        try:
            es_AR = orm['languages.Language'].objects.get(code='es_AR',
    ...
    def backwards(self, orm):
        """Change name of language with code 'es_AR' from
        'Spanish (Argentina)' to 'Spanish (Argentinian)'
        """
        try:
            es_AR = orm['languages.Language'].objects.get(code='es_AR',
                    name='Spanish (Argentina)')
            es_AR.name = 'Spanish (Argentinian)'
            es_AR.save()
        except orm['languages.Language'].DoesNotExist:
            pass
