...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Change name of language with code 'pt_BR' from
        'Portuguese (Brazilian)' to 'Portuguese (Brazil)'
        """
        try:
            pt_BR = orm['languages.Language'].objects.get(code='pt_BR',
    ...
    def backwards(self, orm):
        """Change name of language with code 'pt_BR' from
        'Portuguese (Brazil)' to 'Portuguese (Brazilian)'
        """
        try:
            pt_BR = orm['languages.Language'].objects.get(code='pt_BR',
                    name='Portuguese (Brazil)')
            pt_BR.name = 'Portuguese (Brazilian)'
            pt_BR.save()
        except orm['languages.Language'].DoesNotExist:
            pass
