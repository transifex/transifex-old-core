...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('projects_project', 'owner', orm['projects.Project:owner'])
        
        # Adding field 'Project.private'
        db.add_column('projects_project', 'private', orm['projects.Project:private'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('projects_project', 'owner_id')
        
        # Deleting field 'Project.private'
        db.delete_column('projects_project', 'private')
