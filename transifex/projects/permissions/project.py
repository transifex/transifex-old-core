...
class ProjectPermission(BasePermission):
    ...
    def submit_translations(self, obj, any_team=False):
        ...
        The parameter 'any_team' can be used when a it's necessary to verify 
        if a user has submit access for at least one project team. If an 
        Project object is passed and the parameter 'any_team' id set as False,
        the verification of access will just return True for maintainers and 
        writers.
        """
