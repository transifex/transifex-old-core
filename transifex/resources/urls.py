...
urlpatterns = patterns('',
    ...
    url(r'^project/(?P<project_slug>[-\w]+)/resource/(?P<resource_slug>[-\w]+)/l/(?P<lang_code>[-\w]+)/delete_all/$', resource_translations_delete, name='resource_translations_delete'),
    url(r'^project/(?P<project_slug>[-\w]+)/resource/(?P<resource_slug>[-\w]+)/l/(?P<target_lang_code>[-\w]+)/actions/$', resource_actions, name='resource_actions'),
    ...
    url(r'^project/(?P<project_slug>[-\w]+)/resource/(?P<resource_slug>[-\w]+)/l/(?P<lang_code>[-\w]+)/$', not_available, name='translate'),
    url(r'^project/(?P<project_slug>[-\w]+)/resource/(?P<resource_slug>[-\w]+)/l/(?P<lang_code>[-\w]+)/view/$', not_available, name='view_strings'),
    url(r'^project/(?P<project_slug>[-\w]+)/resource/(?P<resource_slug>[-\w]+)/l/(?P<lang_code>[-\w]+)/download/$', get_translation_file, name='download_translation'),
