...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Translation', fields ['resource', 'language']
        db.create_index('resources_translation', ['resource_id', 'language_id'])

        # Removing index on 'Translation', fields ['source_entity']
        db.delete_index('resources_translation', ['source_entity_id'])

        # Removing index on 'Translation', fields ['resource']
        db.delete_index('resources_translation', ['resource_id'])

        # Removing index on 'Translation', fields ['language']
        db.delete_index('resources_translation', ['language_id'])

        # Adding index on 'Translation', fields ['last_update']
        db.create_index('resources_translation', ['last_update'])


    def backwards(self, orm):

        # Removing index on 'Translation', fields ['last_update']
        db.delete_index('resources_translation', ['last_update'])

        # Removing index on 'Translation', fields['resource_id', 'language_id']
        db.delete_index('resources_translation', ['resource_id', 'language_id'])

        # Adding index on 'Translation', fields ['language']
        db.create_index('resources_translation', ['language_id'])

        # Adding index on 'Translation', fields ['resource']
        db.create_index('resources_translation', ['resource_id'])

        # Adding index on 'Translation', fields ['source_entity']
        db.create_index('resources_translation', ['source_entity_id'])
